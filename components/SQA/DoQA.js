...
function DoQA() {
  ...
  return (
    <Box ref={weeksRef} sx={{ background: "#F8F8F8" }}>
      ...
      >
        <ServicesCard
          image={require('../../assets/svg/sqa-asset-10.svg')}
        ...
        />
        <ServicesCard
          image={require('../../assets/svg/sqa-asset-9.svg')}
        ...
        />
        <ServicesCard
          image={require('../../assets/svg/sqa-asset-8.svg')}
        ...
        />
        <ServicesCard
          image={require('../../assets/svg/sqa-asset-7.svg')}
        ...
        />
        <ServicesCard
          image={require('../../assets/svg/sqa-asset-6.svg')}
        ...
        />
        <ServicesCard
          image={require('../../assets/svg/sqa-asset-5.svg')}
