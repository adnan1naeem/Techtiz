...
import CrossLine from "../../Component/MobileApplication/CrossLine";
import ExpertiseMobile from "../../Component/MobileApplication/ExpertiseMobile";
import OutshineCard from "../../Component/MobileApplication/OutshineCard";
import DoItMobile from "../../Component/MobileApplication/DoItMobile";
import DiscussProject from "../../Component/Website/DiscussProject";
import SalesTeam from "../../Component/SalesTeam/SalesTeam";
import Footer from "../../Component/Footer/Footer";
import DevelopmentMobile from "../../Component/MobileApplication/DevelopmentMobile";
  ...
  return (
    <div>
      ...
      <Box sx={{ marginTop: { xs: "30%", sm: "15%", md: "14%", lg: "13%" } }}>
        ...
        >
          <Box>
            <ExpertiseMobile  title="Our Expertise" des="Guaranteed delivery of an App that satisfies your goals."/>
          </Box>
